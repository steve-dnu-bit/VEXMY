    ...
    <div className="space-y-4">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent>
          ...
          {(settings.reminderChannel === "sms" || settings.reminderChannel === "both") ? (
            <p className="text-xs text-muted-foreground mt-3">
              {t("settings.smsTwilioRequiredDesc")}{" "}
              <Link to="/inbox?connect=sms" className="text-primary hover:underline">
                {t("settings.smsTwilioConnectLink")}
              </Link>
              {" · "}
              <Link to="/docs/sms-twilio-setup" className="text-primary hover:underline">
                {t("settings.smsTwilioGuideLink")}
              </Link>
            </p>
          ) : null}
        </CardContent>
