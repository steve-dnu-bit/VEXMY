...
const BookingLinkAccount = ({
  ...
  <div className="relative" ref={linkAccountWrapRef}>
    <Label className="text-xs uppercase tracking-widest text-muted-foreground">Link customer account</Label>
    <p className="text-[10px] text-muted-foreground mt-0.5 mb-1">Type at least 2 letters — name or portal email</p>
    <div className="relative mt-1">
      <Input
        ...
        placeholder="Optional — search portal accounts"
        autoComplete="off"
