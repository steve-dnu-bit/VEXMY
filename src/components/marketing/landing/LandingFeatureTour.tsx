      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative mx-auto mt-12 max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl border border-gold/20 bg-[#08090e]/90 p-1 shadow-[0_32px_100px_rgba(0,0,0,0.55)]">
            <div
              key={slideId}
              className="animate-in fade-in-0 zoom-in-95 duration-700"
            >
              <SlideFrame id={slideId} />
            </div>
            <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#08090e] to-transparent pointer-events-none" />
          </div>
