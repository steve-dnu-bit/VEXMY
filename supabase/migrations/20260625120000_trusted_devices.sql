-- Trusted devices: skip MFA prompt on known browsers for a limited time.
-- Managed via mfa-trusted-device edge function (service role); no direct client RLS access.
