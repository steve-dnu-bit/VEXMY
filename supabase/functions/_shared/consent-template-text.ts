...
import { defaultConsentForSlug } from "./default-consent-templates.ts";
...
export function applyConsentTemplateVars(content: ConsentFormContent, vars: ConsentTemplateVars, slug = "tattoo"): ConsentFormContent {
